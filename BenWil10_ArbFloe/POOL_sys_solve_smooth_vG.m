function [Rp,Edge,LC,Phi,Phi_n,Psi_hat,Psi_n_hat,svec]=...
             POOL_sys_solve_smooth_vG(matrices,vectors,...
...
% title('u')
% plot(svec/LC, abs(Phi*chi_mat),col) %mat_W0*,svec/LC, mat_W*abs(Psi*chi_mat),col);
% subplot(2,2,2); hold on
% title('v')
% plot(svec/LC, abs(Phi_n*chi_mat),col) %inv(mat_JC_ds0)*,svec/LC, inv(mat_JC_ds)*abs(Psi_n*chi_mat),col);
subplot(2,2,1); hold on
title('w')
...
title('\^{w}_n')
plot(svec/LC, abs(what_n_coeffs.'*chi_mat),col);
...
subplot(2,3,4); hold on
title('u_s')
plot(svec/LC, mat_W*abs((1i*pi/LC)*Psi*diag([-Nterms:Nterms])*chi_mat),col);
subplot(2,3,5); hold on
title('w_s')
plot(svec/LC, abs((1i*pi/LC)*w_coeffs.'*diag([-Nterms:Nterms])*chi_mat),col);
subplot(2,3,6); hold on
title('\^{w}_s')
plot(svec/LC, abs((1i*pi/LC)*what_coeffs.'*diag([-Nterms:Nterms])*chi_mat),col);
clear chi_mat col    
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
