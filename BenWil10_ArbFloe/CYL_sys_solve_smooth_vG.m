function [Rp,LC]=...
             CYL_sys_solve_smooth_vG(matrices,vectors,...
...
title('u')
plot(svec/LC, mat_W0*abs(Phi*chi_mat),col);
subplot(1,2,2); hold on
title('u_s')
plot(svec/LC, mat_W0*abs((i*pi/LC)*Phi*diag([-Nterms:Nterms])*chi_mat),col);
clear chi_mat col
end
