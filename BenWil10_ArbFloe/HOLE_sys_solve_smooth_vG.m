function [Rp,LC]=...
             HOLE_sys_solve_smooth_vG(matrices,vectors,...
...
% - 27.08.09 - solve only for floating plate with neumann conds on vel pot, ie. u = 0
...
% - !!!!!!!!!!!!!!!! TEST !!!!!!!!!!!!!!!! - %
MB1=0*MB1; MB2=MB2; MS1=MS1; MS2=MS2;
...
b_hat=invCMAT*[0*Psi;w_n_coeffs.'; what_n_coeffs.'];
